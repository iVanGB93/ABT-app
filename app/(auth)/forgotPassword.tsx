  ...
  return (
    <ThemedView style={commonStyles.container}>
      <View style={commonStyles.header}>
        ...
        <ThemedText type="subtitle" style={commonStyles.text_header}>
      ...
      >
        <ScrollView keyboardShouldPersistTaps="handled">
          <ThemedText type="subtitle" style={commonStyles.sub_text_header}>
            A link will be sent to your email. Follow the instructions to reset your password.
          </ThemedText>
          <View
            style={[
              commonStyles.action,
              { borderBottomColor: darkTheme ? '#f2f2f2' : '#000', marginTop: 50 },
            ]}
          >
